...
import { TurnoListComponent } from './recepcion-productos/turno-list/turno-list.component';
const routes: Routes = [
    ...
    { path: 'recepcion', loadChildren: () => import('./recepcion-productos/recepcion-productos.module').then(m => m.RecepcionProductosModule) },
  ]},
